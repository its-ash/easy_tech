<template>
  <section>
        ...
        <div class="row align-items-center">
          <div class="col-xxl-6 col-xl-8 col-lg-8 col-md-8">
            <div class="header__info">
              <ul>
                <li>
                  <a href="mailto:easytechkota@gmail.com">
                    ...
                    easytechkota@gmail.com</a>
                </li>
                <li>
                  <a
                    href="https://www.google.com/maps/place/EASYTECH+ACADEMY+KOTA/@25.2257,75.8762,17z/data=!4m5!3m4!1s0x396f9a5d5a32ff53:0xc6d21a0746e3d699!8m2!3d25.225744!4d75.876205?hl=en"
                    target="_blank"
                  >
                    ...
                    71, Rangpur Road No. 4, Dadwara, Kota</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
            <div class="header__top-right d-flex justify-content-end align-items-center">
              <div class="header__btn ml-20">
                <NuxtLink :to="{name: 'contact'}" class="header-btn">Contact</NuxtLink>
              </div>
            </div>
          </div>
        </div>
    ...
    <header>
      <nav class="navbar navbar-expand-sm navbar-light m-0 mx-2 mx-md-5 mt-md-2 d-md-none d-block fixed-top">
        <div class="container-fluid rounded py-0 my-0 mx-md-5 shadow" style="background-color: #f1f1f1">
          <NuxtLink class="navbar-brand" :to="{name: 'index'}">
            <img src="/easyLogo.png" style="width: 100px;" alt="Easy Tech Logo">
          </NuxtLink>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar"
                  aria-controls="navbar" id="toggle-btn" aria-expanded="false" aria-label="Toggle navigation"
          >
          ...
          <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav me-auto mb-2 mb-sm-0">
              <li class="nav-item">
                <NuxtLink class="nav-link fw-bold fs-6" :to="{name: 'index'}">Home</NuxtLink>
              </li>
              <li class="nav-item">
                <NuxtLink class="nav-link fw-bold fs-6" :to="{name: 'courses'}">Course</NuxtLink>
              </li>
              <li class="nav-item">
                <NuxtLink class="nav-link fw-bold fs-6" :to="{name: 'about'}">About</NuxtLink>
              </li>
              <li class="nav-item">
                <NuxtLink class="nav-link fw-bold fs-6" :to="{name: 'contact'}">Contact</NuxtLink>
              </li>
            </ul>
          </div>
        </div>
      ...
      <nav class="navbar navbar-expand-sm navbar-dark m-0 mx-2 mx-md-5 mt-md-2 d-md-flex d-none fixed-top" style="top: 13px">
        <div class="container-fluid rounded py-0 my-0 mx-md-5">
          <NuxtLink class="navbar-brand" :to="{name: 'index'}">
            <div style="background-color: white; width: 100px;height: 60px; filter: blur(20px);z-index: -1" class="position-absolute"></div>
            <img src="/easyLogo.png" style="width: 100px;z-index: 10000" alt="Easy Tech Logo">
          </NuxtLink>
          <div style="background-color: #217a3d" class="w-100 rounded py-2 px-3">
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar"
            ...
            <div class="collapse navbar-collapse" id="navbar">
              <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                <li class="nav-item">
                  <NuxtLink class="nav-link text-white fw-bold fs-6" :to="{name: 'index'}">Home</NuxtLink>
                </li>
                <li class="nav-item">
                  <NuxtLink class="nav-link text-white fw-bold fs-6" :to="{name: 'courses'}">Course</NuxtLink>
                </li>
                <li class="nav-item">
                  <NuxtLink class="nav-link text-white fw-bold fs-6" :to="{name: 'about'}">About</NuxtLink>
                </li>
                <li class="nav-item">
                  <NuxtLink class="nav-link text-white fw-bold fs-6" :to="{name: 'contact'}">Contact</NuxtLink>
                </li>
              </ul>
              <form>
      ...
      <!--      <nav class="navbar header__area header__transparent bg-white">-->
      ...
      <!--                    </NuxtLink>-->
      <!--                  </div>-->
      <!--                  <div class="main-menu main-menu-2 main-menu-border ps-3">-->
      <!--                    <nav id="mobile-menu">-->
      <!--                      <ul>-->
      <!--                        <li>-->
      ...
      <!--                            />-->
      <!--                            <path d="M17 17L13.1333 13.1333" stroke="#3E8454" stroke-width="2" stroke-linecap="round"-->
