<template>
  <div class="py-5">
    <!-- slider area start -->
    <section class="slider__area include-bg d-flex align-items-center">
      <div class="container my-5">
        <div class="row align-items-center">
          <div class="col-xxl-6 col-lg-6">
            <div class="slider__content-2">
              <span>The Leader in Offline Learning</span>
              <h3 class="slider__title-2">Bring Out The Best In YOU!</h3>
              <p>The right mentoring relationship can be a powerful tool for Professional growth. Bark up the right
                tree.</p>
              <NuxtLink :to="{name: 'courses'}" class="tp-btn-green">Explore Courses</NuxtLink>
            </div>
          </div>
          <div class="col-xxl-6 col-lg-6">
            <img class="w-100" src="/home.png" alt="">
          </div>
        </div>
      </div>
    </section>
    ...
    <!--    &lt;!&ndash; category area start &ndash;&gt;-->
    <!--    <section class="category__area py-5 my-5">-->
    <!--      <div class="container">-->
    <!--        <div class="row">-->
    ...
    <!--                      <a href="course-v1.html">-->
    <!--                        <svg width="34" height="30" id="_x31_" enable-background="new 0 0 24 24" viewBox="0 0 24 24"-->
    ...
    <!--                  </div>-->
    <!--                </div>-->
    <!--                &lt;!&ndash;                <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-4 col-6">&ndash;&gt;-->
    <!--                &lt;!&ndash;                  <div class="category__item text-center mb-45">&ndash;&gt;-->
    <!--                &lt;!&ndash;                    <div class="category__icon add">&ndash;&gt;-->
    <!--                &lt;!&ndash;                      <a href="course-v1.html">+</a>&ndash;&gt;-->
    <!--                &lt;!&ndash;                    </div>&ndash;&gt;-->
    <!--                &lt;!&ndash;                    <div class="category__content">&ndash;&gt;-->
    <!--                &lt;!&ndash;                      <h4 class="category__title add">&ndash;&gt;-->
    <!--                &lt;!&ndash;                        <a href="course-v1.html">Add</a>&ndash;&gt;-->
    <!--                &lt;!&ndash;                      </h4>&ndash;&gt;-->
    <!--                &lt;!&ndash;                    </div>&ndash;&gt;-->
    <!--                &lt;!&ndash;                  </div>&ndash;&gt;-->
    <!--                &lt;!&ndash;                </div>&ndash;&gt;-->
    ...
    <!--      </div>-->
    <!--    </section>-->
    <!--    &lt;!&ndash; category area end &ndash;&gt;-->

    <!-- research area start -->
    <!--    <section class="research__area  py-5 my-5">-->
    <!--      <div class="container">-->
    <!--        <div class="row">-->
    ...
    <!--                <div class="research__download-bg include-bg" data-background="assets/img/research/2/research-bg.jpg"-->
    <!--                ></div>-->
    ...
    <!--                    <ul>-->
    <!--                      <li>-->
    <!--                        <a href="#"><img src="assets/img/icon/google-play-store.png" alt="google-play-store"> Google-->
    <!--                          play</a>-->
    <!--                      </li>-->
    <!--                      <li>-->
    ...
    <!--                                      stroke="#6151FB" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"-->
    <!--                                    />-->
    ...
    <!--                                      stroke="#F4930E" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"-->
    <!--                                    />-->
