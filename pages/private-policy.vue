<template>
  <section class="container py-5 my-5">
    ...
    <p>At easytechkota, accessible from http://easytechkota.in/, one of our main priorities is the privacy of our
      ...
      easytechkota and how we use it.</p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
      to the information that they shared and/or collect in easytechkota. This policy is not applicable to any
    ...
    <p>easytechkota follows a standard procedure of using log files. These files log visitors when they visit websites.
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of easytechkota.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on easytechkota, which are sent directly to users' browser.
    ...
    <p>Note that easytechkota has no access to or control over these cookies that are used by third-party
      advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>easytechkota's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <p>easytechkota does not knowingly collect any Personal Identifiable Information from children under the age of 13.
